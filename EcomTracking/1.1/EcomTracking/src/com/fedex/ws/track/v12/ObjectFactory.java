 ...
 * generated in the com.fedex.ws.track.v12 package. 
...
public class ObjectFactory {
    ...
    private final static QName _TrackReply_QNAME = new QName("http://fedex.com/ws/track/v12", "TrackReply");
    private final static QName _SignatureProofOfDeliveryFaxReply_QNAME = new QName("http://fedex.com/ws/track/v12", "SignatureProofOfDeliveryFaxReply");
    private final static QName _SignatureProofOfDeliveryLetterRequest_QNAME = new QName("http://fedex.com/ws/track/v12", "SignatureProofOfDeliveryLetterRequest");
    private final static QName _SendNotificationsRequest_QNAME = new QName("http://fedex.com/ws/track/v12", "SendNotificationsRequest");
    private final static QName _SignatureProofOfDeliveryFaxRequest_QNAME = new QName("http://fedex.com/ws/track/v12", "SignatureProofOfDeliveryFaxRequest");
    private final static QName _TrackRequest_QNAME = new QName("http://fedex.com/ws/track/v12", "TrackRequest");
    private final static QName _SignatureProofOfDeliveryLetterReply_QNAME = new QName("http://fedex.com/ws/track/v12", "SignatureProofOfDeliveryLetterReply");
    private final static QName _SendNotificationsReply_QNAME = new QName("http://fedex.com/ws/track/v12", "SendNotificationsReply");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.fedex.ws.track.v12
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/track/v12", name = "TrackReply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/track/v12", name = "SignatureProofOfDeliveryFaxReply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/track/v12", name = "SignatureProofOfDeliveryLetterRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/track/v12", name = "SendNotificationsRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/track/v12", name = "SignatureProofOfDeliveryFaxRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/track/v12", name = "TrackRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/track/v12", name = "SignatureProofOfDeliveryLetterReply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/track/v12", name = "SendNotificationsReply")

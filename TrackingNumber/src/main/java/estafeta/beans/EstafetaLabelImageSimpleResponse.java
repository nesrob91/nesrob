/**
 * EstafetaLabelImageSimpleResponse.java
 *
...
public class EstafetaLabelImageSimpleResponse  implements java.io.Serializable {
    private GlobalImageSimpleResult globalSimpleResult;
    ...
    public EstafetaLabelImageSimpleResponse() {
    }

    public EstafetaLabelImageSimpleResponse(
           GlobalImageSimpleResult globalSimpleResult,
    ...
    /**
     * Gets the globalSimpleResult value for this EstafetaLabelImageSimpleResponse.
     * 
     * @return globalSimpleResult
     */
    public GlobalImageSimpleResult getGlobalSimpleResult() {
        return globalSimpleResult;
    }


    /**
     * Sets the globalSimpleResult value for this EstafetaLabelImageSimpleResponse.
     * 
     * @param globalSimpleResult
     */
    public void setGlobalSimpleResult(GlobalImageSimpleResult globalSimpleResult) {
        this.globalSimpleResult = globalSimpleResult;
    }


    /**
     * Gets the printerSystem value for this EstafetaLabelImageSimpleResponse.
     * 
    ...
    /**
     * Sets the printerSystem value for this EstafetaLabelImageSimpleResponse.
     * 
     * @param printerSystem
     */
    ...
    /**
     * Gets the valid value for this EstafetaLabelImageSimpleResponse.
     * 
     * @return valid
     */
    ...
    /**
     * Sets the valid value for this EstafetaLabelImageSimpleResponse.
     * 
     * @param valid
     */
    ...
    /**
     * Gets the waybillEstafeta value for this EstafetaLabelImageSimpleResponse.
     * 
    ...
    /**
     * Sets the waybillEstafeta value for this EstafetaLabelImageSimpleResponse.
     * 
    ...
    /**
     * Gets the waybillGeneratorSystem value for this EstafetaLabelImageSimpleResponse.
     * 
    ...
    /**
     * Sets the waybillGeneratorSystem value for this EstafetaLabelImageSimpleResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof EstafetaLabelImageSimpleResponse)) return false;
        EstafetaLabelImageSimpleResponse other = (EstafetaLabelImageSimpleResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(EstafetaLabelImageSimpleResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dto.estafetalabel.webservices.estafeta.com", "EstafetaLabelImageSimpleResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://dto.estafetalabel.webservices.estafeta.com", "GlobalImageSimpleResult"));

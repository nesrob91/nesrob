...
/**
 * <p>Clase Java para ValidateShipmentRequest complex type.
 * 
 ...
 *         &lt;element name="RequestedShipment" type="{http://fedex.com/ws/ship/v19}RequestedShipment"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ValidateShipmentRequest {
    ...
    /**
     * Obtiene el valor de la propiedad requestedShipment.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad requestedShipment.
     * 
     * @param value
     *     allowed object is
     *     {@link RequestedShipment }

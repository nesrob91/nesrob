 ...
 * generated in the fedex.qa package. 
...
public class ObjectFactory {
    ...
    private final static QName _ProcessTagRequest_QNAME = new QName("http://fedex.com/ws/ship/v19", "ProcessTagRequest");
    private final static QName _ShipmentReply_QNAME = new QName("http://fedex.com/ws/ship/v19", "ShipmentReply");
    private final static QName _DeleteTagRequest_QNAME = new QName("http://fedex.com/ws/ship/v19", "DeleteTagRequest");
    private final static QName _ValidateShipmentRequest_QNAME = new QName("http://fedex.com/ws/ship/v19", "ValidateShipmentRequest");
    private final static QName _ProcessShipmentReply_QNAME = new QName("http://fedex.com/ws/ship/v19", "ProcessShipmentReply");
    private final static QName _ProcessShipmentRequest_QNAME = new QName("http://fedex.com/ws/ship/v19", "ProcessShipmentRequest");
    private final static QName _ProcessTagReply_QNAME = new QName("http://fedex.com/ws/ship/v19", "ProcessTagReply");
    private final static QName _DeleteShipmentRequest_QNAME = new QName("http://fedex.com/ws/ship/v19", "DeleteShipmentRequest");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: fedex.qa
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/ship/v19", name = "ProcessTagRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/ship/v19", name = "ShipmentReply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/ship/v19", name = "DeleteTagRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/ship/v19", name = "ValidateShipmentRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/ship/v19", name = "ProcessShipmentReply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/ship/v19", name = "ProcessShipmentRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/ship/v19", name = "ProcessTagReply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/ship/v19", name = "DeleteShipmentRequest")

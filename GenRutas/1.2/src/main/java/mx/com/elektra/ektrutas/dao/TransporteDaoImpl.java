...
public class TransporteDaoImpl implements TransporteDao{
    ...
    public List<Transporte> getTransportes(Integer almacen, Integer transporte) {
        ...
        try{
            ...
            list=sccp.query(sql, paramMap, new RowMapper<Transporte>(){
                @Override
    ...
    public String getTransporteDisponibilidad(Integer almacen, Integer proveedor, Integer eco, String placa, Integer tiempoEco) {
        ...
        Map<String,Object> paramMap=new HashMap<>();
        try{
            fechaF=sccp.queryForObject(fecha, paramMap, Integer.class);
            horaF=sccp.queryForObject(hora, paramMap, Integer.class);
            ...
            disp=sccp.queryForObject(sql, paramMap, String.class);
    ...
    public Integer getTiempoEco(Integer almn) {
        ...
        try{
            ...
            tiempo=sccp.queryForObject(sql, paramMap, Integer.class);
        }catch(EmptyResultDataAccessException e){
            tiempo=99999999;
        }catch(Exception e){
            if(DEBUGGER)
    ...
    public List<Unidad> getUnidades(Integer almacen, Integer unidad, String disp) {
        ...
        try{
            ...
            list=sccp.query(sql, paramMap, new RowMapper<Unidad>(){
                @Override

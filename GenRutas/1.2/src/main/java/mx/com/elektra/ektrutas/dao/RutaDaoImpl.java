...
import mx.com.elektra.ektrutas.dto.EsquemaPagoAcc;
...
public class RutaDaoImpl implements RutaDao{
    ...
    public Integer getFolRut(int tipo, int almacen) {
        ...
        String sql = "select folnum \n" +
            ...
            "and whse = :emisor ";
        String fruta="select info_cd.seq_fruta_"+almacen+".nextval from dual";
        String fenvio="select info_cd.seq_fenvio_"+almacen+".nextval from dual";
        ...
        try{
            ...
            if(almacen == 9971){
                switch(tipo){
                    case 5:
                        folio=sccp.queryForObject(fruta, paramMap, Integer.class);
                        break;
                    case 6:
                        folio=sccp.queryForObject(fenvio, paramMap, Integer.class);
                        break;
                    default:
                        folio=sccp.queryForObject(sql, paramMap, Integer.class);
                        break;
                }
            }else{
                folio=sccp.queryForObject(sql, paramMap, Integer.class);
    ...
    public boolean updateFolRut(int tipo, int almacen, int folio) {
        ...
        try{
            ...
            paramMap.put("emisor",almacen);
            updated=sccp.update(sql, paramMap)>0;
        }catch(Exception e){
            updated = false;
            if(DEBUGGER)
                System.out.println("ERROR : "+e.getMessage());
    ...
    public Integer getDiasTol(int almacen) {
        ...
        try{
            ...
            dias = sccp.queryForObject(sql, paramMap, Integer.class);
        }catch(Exception e){
            dias = 1;
        }
        return dias;
    ...
    public boolean existsMDN(int mdn, int almacen) {
        ...
        try{
            ...
            exists=sccp.queryForObject(sql, param, Integer.class)>0;
        }catch(Exception e){
    ...
    public List<Map<String,Object>> validateRemisionTranrut(List<Remision> rem) {
        ...
        try{
            ...
            result=sccp.queryForList(r.replace("[", "").replace("]", ""), param);
    ...
    public double getFacorEstiba(String aplicacion) {
        ...
        try{
            ...
            fe=sccp.queryForObject(sql, param, Double.class);
        }catch(EmptyResultDataAccessException e){
            fe=0;
        }catch(Exception e){
            if(DEBUGGER)
    ...
    public double getMtsLibres(Integer almacen, Integer idTransporte, Integer idUnidad, double mts, String placa, Integer tiempoEco){
        ...
        try{
            ...
            mtsLibre=sccp.queryForObject(sql, param, Double.class);
        }catch(Exception e){
            mtsLibre=-1;
        }
        return mtsLibre;
    ...
    public Map<String,Double> getMtsPago_Imp(Integer emisor, Integer destino, double mtsPagar) {
        ...
        try{
            ...
            result=sccp.queryForObject(sql, param, new RowMapper<Map<String,Double>>() {
                @Override
    ...
    public Map<String, Double> getVolumenTarifa(Integer ori, String folrems) {
        ...
        Map<String,Object> param = new HashMap<>();
        try{
            SimpleJdbcCall call = new SimpleJdbcCall(sccp.getJdbcTemplate());
    ...
    public Map<String, Double> getVolumen_Precio(Integer ori, Integer des, double mts, String folrems, double kms, double impMax) {
        ...
        try{
            ...
            result = sccp.getJdbcTemplate().call(new CallableStatementCreator() {
                @Override
    ...
    public double getMtsPagar(Integer emisor, Integer destino, double mtsEst, boolean min) {
        ...
        try{
            ...
            if(min)
                mtsPagar=sccp.queryForObject(sqlMin, param, Double.class);
            else
                mtsPagar=sccp.queryForObject(sqlMax, param, Double.class);
        }catch(EmptyResultDataAccessException e){
    ...
    public double getIva(Integer emisor, Integer tienda) {
        ...
        SimpleJdbcCall call=new SimpleJdbcCall(sccp.getJdbcTemplate().getDataSource());
    ...
    public boolean isSinIva(Integer idTransporte){
        ...
        try{
            param.put("vi_prov",idTransporte);
            isIva=sccp.queryForObject(sql, param, Integer.class)>0;
        }catch(Exception e){
            if(DEBUGGER)
                System.out.println("ERROR : "+e.getMessage());
            try{
    ...
    public Map<String, Object> getKmsTR(Integer origen, Integer destino) {
        ...
        try{
            ...
            param.put("vi_destino",destino);
            kmsTR=sccp.queryForObject(sql, param, new RowMapper<Map<String,Object>>(){
                @Override
    ...
    public double getFactorDescuentoTransp(Integer origen){
        ...
        try{
            ...
            fd=sccp.queryForObject(sql, param, Double.class);
        }catch(Exception e){
            if(DEBUGGER)
                System.out.println("ERROR : "+e.getMessage());
            try{
    ...
    public boolean insertCobroTransportistas(int tipoRuta, Integer origen, Integer destino, Integer idTransp, Integer folrut, double importe, double descuento) {
        ...
        try{
            ...
            insert=sccp.update(sql, param)>0;
        }catch(Exception e){
...
" :v_ftfepe, :v_ftfoct, :v_ftfect, :v_ftfocp, :v_ftfecp, :vi_checador, :vi_estibador )";
    ...
    public boolean cancelTranrut(Integer origen, List<String> rutas){
        ...
        return sccp.update(sql, param)>0;
    }
    ...
    public List<EsquemaPago> getConceptosPago(Integer origen, Integer destino, Integer proveedor){
        ...
        String sql = "select \n" +
            ...
            "--info tipo contenido \n" +
            ",cpt.id_tipo tipo_guia,cpt.origen origen_tipo_guia,cpt.descripcion,cpt.nvl_clasificacion nivel_clasificacion \n" +
            "--info nivel clasificacion\n" +
            ",cpnt.id_nivel,cpnt.descripcion desc_nivel_clasificacion \n" +
            "--info clasificacion por tipo\n" +
            ",cpc.id_tipo tipo_clasf,cpc.origen origen_clasf,cpc.clasificacion  \n" +
            "--info importe clasificacion x tipo_sku\n" +
            ",cps.id_tipo tipo_guia_sku,cps.origen origen_tipo_guia_sku,cps.destino destino_tipo_guia_sku,cps.IMPORTE importe_sku,cps.ID_ACC flg_volumen\n" +
            "--info importe volumen (sim) (by origen- as of feb,2021)\n" +
            ",cpa.ID_TIPO_ACC,cpa.ORIGEN origen_tipo_accesorio,cpa.destino destino_tipo_accesorio,cpa.DESCRIPCION desc_accesorio,cpa.IMPORTE importe_accesorio,cpa.VOLUMEN_MIN,cpa.VOLUMEN_MAX \n" +
            ...
            "left join info_cd.conceptos_pago_nvl_tipo cpnt on cpt.NVL_CLASIFICACION = cpnt.ID_NIVEL and cpnt.FLG_ACTIVE = 1\n" +
        ...
        try{
            ...
            conceptos = sccp.query(sql, param, new RowMapper() {
                @Override
    ...
    @Override
    public List<EsquemaPagoAcc> getAccesorioConceptosPago(Integer origen, Integer destino) {
        String sql = "select --info importe clasificacion accesorios (by origen- as of feb,2021)\n" +
            "cpa.ID_TIPO_ACC,cpa.ORIGEN origen_tipo_accesorio,cpa.DESCRIPCION desc_accesorio,cpa.IMPORTE importe_accesorio,cpa.VOLUMEN_MIN,cpa.VOLUMEN_MAX \n" +
            "from info_cd.conceptos_pago_acc_tipo cpa \n" +
            "where cpa.ORIGEN=:origen \n" +
            "and cpa.FLG_ACTIVE = 1";
        List<EsquemaPagoAcc> accesoriosTipo=new ArrayList<>();
        Map<String,Object> param=new HashMap<>();
        try{
            param.put("proveedor",origen);
            accesoriosTipo = sccp.query(sql, param, new RowMapper() {
                @Override
                public EsquemaPagoAcc mapRow(ResultSet rs, int rowNum) throws SQLException {
                    EsquemaPagoAcc acc=new EsquemaPagoAcc();
                    acc.setDescAccesorioTipo(rs.getString("DESC_ACCESORIO"));
                    acc.setIdAccesorio(rs.getInt("ID_TIPO_ACC"));
                    acc.setImporteAcc(rs.getDouble("IMPORTE_ACCESORIO"));
                    acc.setOrigenAccesorio(rs.getInt("ORIGEN_TIPO_ACCESORIO"));
                    acc.setVolumenMax(rs.getDouble("VOLUMEN_MAX"));
                    acc.setVolumenMin(rs.getDouble("VOLUMEN_MIN"));
                    return acc;
                }
            });
        }catch(Exception e){

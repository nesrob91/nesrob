...
public class TiendaDaoImpl implements TiendaDao{
    ...
    public Integer isDistItk(List<Integer> tienda) {
        ...
        try{
            ...
            isDist=sccp.queryForObject(sql, paramMap, Integer.class);
        }catch(Exception e){
            if(DEBUGGER)
    ...
    public Integer isCD(Integer tienda) {
        ...
        try{
            ...
            isCd=sccp.queryForObject(sql, paramMap, Integer.class);
        }catch(Exception e){
            if(DEBUGGER)
                System.out.println("ERROR : "+e.getMessage());
            try{
    ...
    public String getPaisTda(Integer tda){
        ...
        try{
            ...
            pais=sccp.queryForObject(sql, paramMap, String.class);
        }catch(Exception e){
            if(DEBUGGER)
                System.out.println("ERROR : "+e.getMessage());
            try{
